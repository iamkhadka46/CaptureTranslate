...
@LargeTest
public class SpanishToEnglishTranslationTest {
    ...
    public void translate_SpanishToEnglish() throws InterruptedException {
        ...
        onView( withId( R.id.sourceText ) ).perform( typeText( "Hola, Como estas" ) );
        onView(withId(R.id.translate)).perform(click());
        Thread.sleep( 1500 );
        onView(withId(R.id.translatedText)).check(matches(withText("Hi how are you")));
